...
<head>
    ...
    <!-- MODIFICAR SELECT ANCHO -->
    <style>
        .select2-container .select2-selection--single {
            height: 58px;
            /* Altura del contenedor select2 */
        }

        .select2-container--default .select2-selection--single .select2-selection__rendered {
            line-height: 48px;
            /* Altura de la línea para alinear el texto verticalmente */
        }
...
<body class="hold-transition sidebar-mini layout-fixed">
    <div class="wrapper">
        ...
        <div class="content-wrapper">
            ...
            $queryUsuarios = "SELECT ID, USERNAME, NAME FROM users";
            ...
            <div class="container">
                <form action="asignaRol.php" method="POST">
                    <div class="card-body">
                        <h4>Asignación de roles para usuarios del sistema</h4><br>
                        <div class="row">
                            <div class="col-12 col-sm-6">
                                <div class="form-group">
                                    <label>Seleccione el usuario</label>
                                    <div class="select2-orange">
                                        <select name="usuarioUsername" class="select2" data-placeholder="Usuario" data-dropdown-css-class="select2-orange" style="width: 100%; height: 50px;" required>
                                            <option></option>
                                            <?php foreach ($usuarios as $usuario) : ?>
                                                <option value="<?php echo $usuario['USERNAME']; ?>"><?php echo $usuario['USERNAME'] . " - " . $usuario['NAME']; ?></option>
                                            <?php endforeach; ?>
                                        </select>
                                    </div>
                                </div>
                            ...
                            <div class="col-12 col-sm-6">
                                <div class="form-group">
                                    ...
                                    <div class="select2-orange">
                                        <select name="rol" class="select2" data-placeholder="Rol" data-dropdown-css-class="select2-orange" style="width: 100%;" required>
                                            <option></option>
                                            <option value="ADMINISTRADOR">ADMINISTRADOR</option>
                                            <option value="CLIENTE">CLIENTE</option>
                                            <!-- Añade otros roles según sea necesario -->
                                        </select>
                                    </div>
                                </div>
                                <!-- /.form-group -->
